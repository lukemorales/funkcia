...
import { Panic, TaggedError } from './exceptions';
  ...
  describe('constructors', () => {
    ...
    describe('Do', () => {
      it('creates an `Option` with an empty object branded with the DoNotation type', () => {
        ...
        expectTypeOf(option).toEqualTypeOf<Option<DoNotation>>();
    ...
    describe('fn', () => {
      ...
      it('returns an async function with improved inference without changing behavior', async () => {
        function* hasEnabledSetting(enabled: boolean | null) {
          const value = yield* Option.fromNullable(enabled);
        ...
        expectTypeOf(hasEnabledSetting).toEqualTypeOf<
          ...
          ) => Generator<never, Option<'YES'> | Option<'NO'>, undefined>
        >();
  ...
  describe('instance', () => {
    describe('bindTo', () => {
      it('binds the current `Option` to a `do-notation`', () => {
        ...
        expectTypeOf(option).toEqualTypeOf<Option<DoNotation<{ a: number }>>>();
