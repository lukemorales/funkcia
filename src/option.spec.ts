...
describe('Option', () => {
  describe('constructors', () => {
    describe('is', () => {
      it('returns true if the value is an Option', () => {
        const option = Option.some('hello world');

        expect(Option.is(option)).toBeTrue();
      });

      it('returns false if the value is not an Option', () => {
        expect(Option.is({ value: 'hello world' })).toBeFalse();
      });
    });
    ...
    describe('of', () => {
      it('creates a Some Option with the given value', () => {
        const option = Option.of('hello world');
    ...
    describe('Do', () => {
      it('creates an `Option` with an empty object branded with the DoNotation type', () => {
        ...
        expectTypeOf(option).toEqualTypeOf<Option<DoNotation.Sign>>();
    ...
    describe('func', () => {
      ...
      it('returns an async function with improved inference without changing behavior', async () => {
        ...
        expectTypeOf(hasEnabledSetting).toEqualTypeOf<
          ...
          ) => Promise<Option<'YES'> | Option<'NO'> | Option<never>>
        >();
    ...
    describe('enhance', () => {
      it('wraps a function that might throw exceptions returning a function that returns an Option', () => {
        const safeDivide = Option.enhance(
    ...
    describe('createUse', () => {
      it('returns a function that safely evaluates a generator, returning the returned Option when all yields are `Some`', () => {
        const execute = Option.createUse(function* (
          greeting: string,
          subject: string,
        ) {
          const a = yield* Option.fromFalsy(greeting);
          expect(a).toBe('hello');

          const b = yield* Option.fromFalsy(subject);
          expect(b).toBe('world');
        ...
        expectTypeOf(execute).toEqualTypeOf<
          (greeting: string, subject: string) => Option<string>
        >();

        const option = execute('hello', 'world');
        expectTypeOf(option).toEqualTypeOf<Option<string>>();
  ...
  describe('instance', () => {
    ...
    describe('toAsyncOption', () => {
      it('returns a `OptionAsync` from the original `Option`', async () => {
        const option = Option.some('hello world');
    ...
    describe('toAsyncResult', () => {
      it('returns a `ResultAsync` from the original `Option`', async () => {
        const option = Option.some('hello world');
      ...
      it('returns a `ResultAsync` from the original `Option` with a custom error', async () => {
        const option = Option.none<string>();
        const taskResult = option.toAsyncResult(
          () => new Error('computation failed'),
        );

        expectTypeOf(taskResult).toEqualTypeOf<ResultAsync<string, Error>>();
