    ...
    PromiseLike<Result<Value, Error>>
{
  ...
  static ok<Value>(value: Value): AsyncResult<Value, never> {
    return new AsyncResult(() => Promise.resolve(ResultRef.value.ok(value)));
  }
   ...
   * ```
   */
  static of: <Value>(value: Value) => AsyncResult<Value, never> = // eslint-disable-line @typescript-eslint/no-shadow
    AsyncResult.ok;
   ...
   * ```
   */
  static error<Error>(error: NonNullable<Error>): AsyncResult<never, Error> {
    return new AsyncResult(() => Promise.resolve(ResultRef.value.error(error)));
  }
  ...
  ): AsyncResult<Value, NoValueError>;
  ...
  static fromFalsy<Value>(
    value: Value | Falsy,
  ): AsyncResult<Exclude<NonNullable<Value>, Falsy>, NoValueError>;
  ...
  ): AsyncResult<Exclude<NonNullable<Value>, Falsy>, Error>;
  ...
  static fromFalsy(
    ...
    if (!value)
      return AsyncResult.error(onFalsy?.(value) ?? new NoValueError()) as never;

    return AsyncResult.ok(value) as never;
  }
   ...
   * ```
   */
  static try<$Result extends Result<any, any>>(
    promise: Task<$Result>,
  ): AsyncResult<
   ...
   * ```
   */
  static try<Value>(promise: Task<Value>): AsyncResult<Value, UnknownError>;
   ...
   * ```
   */
  static try<$Result extends Result<any, any>, Error extends {}>(
    promise: Task<$Result>,
   ...
   * ```
   */
  static promise<$Result extends Result<any, any>>(
    promise: Task<$Result>,
  ): AsyncResult<
    AsyncResult.Unwrap<$Result>,
    AsyncResult.UnwrapError<$Result>
  > {
    return new AsyncResult(promise) as never;
  }
  ...
  ): (...args: Args) => AsyncResult<Value, UnknownError>;
  ...
  >(
    promise: (...args: Args) => Promise<Value>,
    onrejected: (e: unknown) => RejectionError,
  ): (...args: Args) => AsyncResult<Value, RejectionError>;
  ...
  static predicate<Criteria extends Predicate.Predicate<any>>(
    ...
    ? AsyncResult<Input, FailedPredicateError<Input>>
    : never;
  ...
  static predicate<Criteria extends Predicate.Predicate<any>, Error extends {}>(
    ...
    ? AsyncResult<Input, Error>
    : never;

  static predicate(
    criteria: Predicate.Predicate<any>,
    onUnfulfilled?: (input: any) => any,
  ): (value: any) => AsyncResult<any, any> {
    return (value) =>
      AsyncResult.of(value).filter(criteria, onUnfulfilled as never);
  }
   ...
   * //       ▼
   * const result = AsyncResult.relay(async function* () {
   ...
   */
  zip<Value2, Error2>(
    that: AsyncResult<Value2, Error2>,
  ): AsyncResult<
  ...
  ): AsyncResult<Output, Error | Error2> {
   ...
   */
  static get Do(): AsyncResult<DoNotation.Sign, never> {
    return new AsyncResult(() => Promise.resolve(ResultRef.value.Do));
  }
  ...
  bindTo<Key extends string>(
    key: Key,
  ): AsyncResult<DoNotation.Sign<{ readonly [K in Key]: Value }>, Error> {
    return AsyncResult.Do.bind(key as never, () => this as never) as never;
  }
  ...
  bind<Key extends string, ValueToBind, NewError>(
    ...
    cb: (ctx: DoNotation.Unsign<Value>) => AsyncResult<ValueToBind, NewError>,
  ): AsyncResult<
    DoNotation.Sign<{
    ...
    Error | NewError
  > {
    return (this as AsyncResult<Value, Error>).andThen((ctx) =>
      cb(ctx).map(
        (value) =>
  ...
  > {
    ...
    return (this as AsyncResult<Value, Error>).bind(key, (ctx) =>
      AsyncResult.promise(() => cb(ctx).then(ResultRef.value.ok)),
    );
  }
   ...
   * ```
   */
  andThen<Output extends Result<any, any>>(
    onOk: (value: DoNotation.Unsign<Value>) => Output,
  ): AsyncResult<
   ...
   * ```
   */
  andThen<Output extends AsyncResult<any, any>>(
    onOk: (value: DoNotation.Unsign<Value>) => Output,
  ): AsyncResult<
    AsyncResult.Unwrap<Output>,
    Error | AsyncResult.UnwrapError<Output>
  ...
  andThen<Output, NewError>(
    ...
    ) => Result<Output, NewError> | AsyncResult<Output, NewError>,
  ): any {
    const flattenedPromise = async () => {
      try {
        ...
        return AsyncResult.error(e as never) as never;
      }
    };

    return new AsyncResult(flattenedPromise) as never;
  }
  ...
  ): AsyncResult<Value, Error | FailedPredicateError<DoNotation.Unsign<Value>>>;
  ...
  or<NewValue, NewError>(
    onError: (error: Error) => AsyncResult<NewValue, NewError>,
  ): AsyncResult<Value | NewValue, Error | NewError> {
    return new AsyncResult(
      () =>
